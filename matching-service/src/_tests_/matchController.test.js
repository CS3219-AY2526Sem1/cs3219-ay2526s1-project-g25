...
describe('matchController.js', () => {
  ...
  describe('leaveQueue', () => {
    ...
    it('should successfully leave queue and return result', () => {
      const mockResult = { removed: true };
      mockQueue.leave.mockReturnValue(mockResult);
  ...
  describe('getStatus', () => {
    ...
    it('should return status when user is found', () => {
      const mockResult = { status: 'WAITING', userId: 'user123' };
      mockQueue.getStatus.mockReturnValue(mockResult);
  ...
  describe('handleDisconnect', () => {
    ...
    it('should successfully handle disconnect and return result', () => {
      const mockResult = { ok: true, mode: 'SOLO' };
      mockQueue.handleDisconnect.mockReturnValue(mockResult);
    ...
    it('should return 400 when result is not ok', () => {
    ...
    it('should handle requeue action', () => {
